...
function [results]  = compareParameters(fitDir, truthDir, outputFile)
...
%   Set up mask
mask = load_nii([fitDir, 'nodif_brain_mask.nii']);
mask = mask.img;
...
for i=1:numberOfVoxels
    ...
    angleDyad1(i) = real(acos(td1'*fd1));
    angleDyad2(i) = real(acos(td2'*fd2));
...
results.angleDyad1 = angleDyad1;
results.angleDyad2 = angleDyad2;
results.angleTruth = angleTruth;
results.allF1 = allF1;
results.allF2 = allF2;
results.fitdiffF1 = fitdiffF1;
results.fitdiffF2 = fitdiffF2;
results.meand = meand;
results.fitdiffmeand = fitdiffmeand;
