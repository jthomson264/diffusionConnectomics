...
maskfile = '../testEditedVox/nodif_brain_mask.nii';
outputdir = '../fakeSynthedImages/';
...
save_nii(meanfTemplate, 'mean_f1samples.nii');
meanfTemplate.img = truth_meanf2;
save_nii(meanfTemplate, 'mean_f2samples.nii');
