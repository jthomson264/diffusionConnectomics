function [ finished ] = synthNoisedImages(prefix, N_images)
...
truthImageFile=['~/data/', prefix, '/groundTruth.nii'];
...
for image_index = 1:N_images
    ...
    fileName = ['~/data/', prefix, '/draw', int2str(image_index), '.nii'];
    niiToWrite = truth;
    ...
    srcName = ['~/data/', prefix, '/draw', int2str(image_index), '.src'];
