function [ ADC, logLikelihood, Nus ] = solveIsotropicWithBvals( bvals, sigma2s, Xs, N_iter)
...
bvalues = double(bvals);            %  I believe these are correct and I don't need to square them.
DWIvalues = double(Xs);
DWIratios = DWIvalues ./ double(Xs(1));
sigma2s = double(sigma2s);
